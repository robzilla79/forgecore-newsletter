# ForgeCore AI Brief — 2025-10-23 — 2025-10-23
...
## Why It Matters
- NVIDIA DGX Spark with 8x A100 GPUs (320GB VRAM).
- Release day firmware for NVIDIA A100 GPUs.
- Run Ollama's benchmark suite on each model to measure performance in terms of throughput (requests per second) and latency (milliseconds).
- Compare the results with other popular AI models to assess Ollama's performance relative to its competitors.
